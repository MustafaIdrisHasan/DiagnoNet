...
class VitalsAgent:
    ...
    # Mapping from vitals conditions to more clinical disease names
    CONDITION_TO_DISEASE = {
        "Respiratory_Distress": "Acute Respiratory Syndrome",
        "Tachycardia": "Sinus Tachycardia",
        "Bradycardia": "Sinus Bradycardia",
        "Hypertension": "Essential Hypertension",
        "Hypotension": "Hypotensive Episode",
        "Fever": "Febrile Syndrome",
        "Hypothermia": "Hypothermic Condition"
    }
    ...
    def analyze_vitals(self, vitals: Dict[str, float]) -> Dict:
        ...
        # Map condition to more clinical disease name
        primary_condition = self.conditions[prediction]
        primary_diagnosis = self.CONDITION_TO_DISEASE.get(primary_condition, primary_condition)
